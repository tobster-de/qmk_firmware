...
uint8_t init_mcp23018(void) {
    ...
    mcp23018_status = i2c_write(IODIRA, ERGODOX_I2C_TIMEOUT);            if (mcp23018_status) goto out;
    mcp23018_status = i2c_write(0b00000000, ERGODOX_I2C_TIMEOUT);        if (mcp23018_status) goto out;
    mcp23018_status = i2c_write(0b00111111, ERGODOX_I2C_TIMEOUT);        if (mcp23018_status) goto out;
    ...
    // - driving : off : 0
    mcp23018_status = i2c_start(I2C_ADDR_WRITE, ERGODOX_I2C_TIMEOUT);    if (mcp23018_status) goto out;
    mcp23018_status = i2c_write(GPPUA, ERGODOX_I2C_TIMEOUT);             if (mcp23018_status) goto out;
    mcp23018_status = i2c_write(0b00000000, ERGODOX_I2C_TIMEOUT);        if (mcp23018_status) goto out;
    mcp23018_status = i2c_write(0b00111111, ERGODOX_I2C_TIMEOUT);        if (mcp23018_status) goto out;
...
#define LEFT_LED_3_SHIFT        7       // in MCP23018 port A
    ...
    mcp23018_status = i2c_write(OLATA, ERGODOX_I2C_TIMEOUT);
    if (mcp23018_status) goto out;
